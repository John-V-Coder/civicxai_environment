...
class HybridQueryView(APIView):
    ...
    def post(self, request):
        ...
        Body:
        {
            ...
            "context": {...},
            "files": [...],
            "force_mode": "auto|metta|cognitive|gateway|hybrid"
        }
        """
        try:
    ...
    def _query_metta(self, query: str, context: dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'explanation': f'Calculated priority score based on metrics: {priority_score:.2f}',
    ...
    def _query_hybrid(self, query: str, region_id: str, context: dict, files) -> Dict[str, Any]:
        ...
        try:
            ...
            combined = hybrid_responder.combine_metta_with_reasoning(
            ...
            return {
                ...
                'sources': {
                    'metta': bool(metta_result and metta_result.get('success')),
                    'cognitive': bool(cognitive_result and cognitive_result.get('success')),
                    'gateway': bool(gateway_result and gateway_result.get('success'))
                },
                'success': True
            }
        except Exception as e:
...
class CognitiveRegionAnalysisView(APIView):
    ...
    def _comprehensive_analysis(self, region_id: str, reasoner, knowledge) -> Dict[str, Any]:
        ...
        region_data = {}
        if hasattr(knowledge, 'get_region_info'):
            try:
                region_data = knowledge.get_region_info(region_id)
            except:
                pass
        ...
        try:
            ...
            poverty_analysis = {'error': 'Poverty analysis unavailable'}
        
        try:
            allocation_analysis = reasoner.reason_about_region(region_id, 'allocation')
        except:
            allocation_analysis = {'error': 'Allocation analysis unavailable'}
        
        return {
            'region_data': region_data,
            'poverty_analysis': poverty_analysis,
            'allocation_analysis': allocation_analysis,
            'knowledge_base_stats': knowledge.get_knowledge_stats(),
            'timestamp': time.time()
        }
...
class CognitiveKnowledgeIngestView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            source_id = request.data.get('source_id', f'DOC_{int(time.time())}')
